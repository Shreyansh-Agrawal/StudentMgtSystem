...
def prompt_add_student():
    ...
    try:
        ...
        student_controller.add_student(roll_no, name, age, gender, phone, date_of_joining, date_of_entry)
    except ValueError:
...
def prompt_search_student():
    ...
    try:
        ...
        print(tabulate(student, headers={'roll_no': 'Roll No.', 
                                         'name': 'Name', 
                                         'age': 'Age', 
                                         'gender': 'Gender', 
                                         'phone': 'Phone', 
...
def search_all_students():
    ...
    print(tabulate(students, headers={'roll_no': 'Roll No.', 
                                      'name': 'Name', 
                                      'age': 'Age', 
                                      'gender': 'Gender', 
                                      'phone': 'Phone', 
